	...
	public void SelectData()
	{
	   //Create The Session
		...
		try(sec)
		{
			...
			Query query=sec.createQuery("from BankAccount");
			List<BankAccount> bank=query.getResultList();
			bank.forEach(Ban->{
				System.out.println("The Child Are:----"+Ban);
				Persion per=Ban.getPersion();
				System.out.println("The Parent Are:--------"+per);
