...
public class ImplOfMTMMethods implements IManyToManyAssociationMethod
{
	...
	public void InsertDataUsingParent()
	{
		...
		doc1.setPatient(Set.of(pt1,pt3,pt4));
		doc2.setPatient(Set.of(pt1,pt2,pt4,pt5));
		
		//Add Parent Under Child Object
		pt1.setDoctor(Set.of(doc1,doc2));
		pt2.setDoctor(Set.of(doc2));
		pt3.setDoctor(Set.of(doc1));
		pt4.setDoctor(Set.of(doc1,doc2));
		pt5.setDoctor(Set.of(doc2));
		try(sec)
		{
			//begin Tranction
