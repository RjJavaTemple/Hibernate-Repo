...
public class DeleteTheCriteriaQuery 
{
   public static void main(String[] args)
   {
	  //Create The SessionFactory
	   ...
	   try(factory;sec)
	   {
		   ...
		   CriteriaDelete<SetAndGetImp> CriQuery=builder.createCriteriaDelete(SetAndGetImp.class);
		   //Create The Root Object
		   Root<SetAndGetImp> root=CriQuery.from(SetAndGetImp.class);
		 //Create The Logic
		   CriQuery.where(root.get("ActorColor").isNull());
