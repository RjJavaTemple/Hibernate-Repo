...
public class Multi_Select_Scalar_Query 
{
   public static void main(String[] args)
   {
	  //Create The SessionFactory
	   ...
	   try(factory;sec)
	   {
		   ...
		   //Add The Column Name
		   CriQuery.multiselect(root.get("ActorId"),root.get("ActorName")).where(root.get("ActorAddress"
		   		+ "").in("hyd","mum","chandi")).orderBy(builder.asc(root.get("ActorAddress")));
