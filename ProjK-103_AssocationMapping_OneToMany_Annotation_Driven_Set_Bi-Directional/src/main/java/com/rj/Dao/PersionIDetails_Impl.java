...
public class PersionIDetails_Impl implements IPersionDetails 
{
	...
	{ 
		...
		BankAccount Ba1=new BankAccount("Iccici-1","Current","Hyd");
		BankAccount Ba2=new BankAccount( "Hdfc-1","Sallary","Mum");
		
		//Add The Parent Object
		Persion per=new Persion("Chinky-1","Osera",Set.of(Ba1,Ba2));
